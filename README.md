...
분석 단계,적용 기술,R² Score,비고
Baseline,원본 데이터 + Linear Regression,0.75,프로젝트 초기 기준점
Step 1,전체 이상치 제거 + 로그 변환,0.87,전처리 및 분포 정규화
Step 2,"앙상블 모델 (XGBoost, RandomForest)",0.91,알고리즘 고도화 단계
Final,그룹별 95% 정밀 정제 + 최적화,0.97,최종 성능 달성
---
